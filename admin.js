...
const ADMIN_CONFIG = {
    ...
    SUPABASE_ANON_KEY: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZocXJicmxvc3FuenBxdHhoeXBjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTY0MDk2MDAsImV4cCI6MjAzMTk4NTYwMH0.placeholder',
...
// ==================== SUPABASE CLIENT ====================
const supabase = window.supabase.createClient(ADMIN_CONFIG.SUPABASE_URL, ADMIN_CONFIG.SUPABASE_ANON_KEY);
